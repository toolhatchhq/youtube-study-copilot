...
- Use the public support page or [open a support issue](https://github.com/toolhatchhq/youtube-study-copilot/issues/new/choose) for billing confusion, activation problems, or product issues.
- Keep the email address used at checkout available when asking for billing help.
